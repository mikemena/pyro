...
class ModelVisualizer:
    ...
    def plot_training_history(self, train_losses, val_losses, display=True, save=True, filename='training_history.png'):
    ...
    def plot_confusion_matrix(self, y_true, y_pred, display=True, save=True, filename='confusion_matrix.png'):
    ...
    def plot_data_distribution(self, data, column_names, max_cols=3, display=True, save=True, filename='data_distribution.png'):
        """Plot histogram of numerical features to show data distribution with improved readability"""
        df = pd.DataFrame(data, columns=column_names)
        n_features = len(column_names)
        n_rows = (n_features + max_cols - 1) // max_cols  # Dynamic rows based on features
    ...
    def plot_prediction_distribution(self, predictions, targets, display=True, save=True, filename='prediction_distribution.png'):
    ...
    def plot_roc_curve(self, y_true, y_pred, display=True, save=True, filename='roc_curve.png'):
        """Plot ROC curve"""
    ...
    def plot_precision_recall_curve(self, y_true, y_pred, display=True, save=True, filename='precision_recall_curve.png'):
    ...
    def plot_metrics_bar(self, metrics, display=True, save=True, filename='metrics_bar.png'):
